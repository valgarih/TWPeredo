...
class Index extends React.Component {
  ...
  leerjson(){
   ...
   eliminar = value => () =>{
    ...
    if (confirm('Estas seguro de borrar esta pregunta?')) {
       window.location.replace("EliminarFV?preguntaEliminada="+value)
    } 
  } 
  ...
  render() {
    ...
    <Paper className={classes.root} >
        ...
        Preguntas Verdadero y Falso <Icon className={classes.icon} color="secondary">favorite</Icon>
        </Typography>
        <br /><br />
      <Paper>
          ...
          {this.state.preguntas.map(row => {
            return (
              <TableRow className={classes.row}>
                ...
                <CustomTableCell> 
                    <IconButton aria-label="Ver Pregunta" className={classes.margin} color="secondary" onClick = {() => window.location.replace("VistaPFV?pregunta="+row)}> 
                        <Icon className={classes.icon}>visibility</Icon> 
                    </IconButton>  
                    <IconButton aria-label="Editar Pregunta" className={classes.margin} color="primary" onClick = {() => window.location.replace("EditarPFV?pregunta="+row)}>  
      ...
      <a href="archivosFV.html" style={{ color: '#FFF' }} >
...
const MenuFV = withStyles(styles)(Index);
ReactDOM.render(<MenuFV/>, document.getElementById('root'));
