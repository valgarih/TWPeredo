...
class Index extends React.Component { //clase base 
  constructor(props){
      super(props); // lo invocamos par poder usar "this" 
      this.state = {
          email : "",
          password : ""
      }
  ...
  handleInputChange = (event) => { //establece el estado nuevamente, según el campo de entrada que se está editando actualmente.
       event.preventDefault; //evita el envio 
       this.setState({
